use std::{
    arch::x86_64::{
        __m256d, __m256i, _mm256_cmp_pd, _mm256_cmpeq_epi64, _CMP_EQ_OQ,
    },
    convert::Infallible,
    marker::PhantomData,
};
...
use super::{
    avx2::{
        ...
        BinaryOpCmpI64Avx2Aware, AVX2_I64_ELEM_COUNT,
    },
    BinaryOp,
};
...
impl BinaryOpCmpI64Avx2Aware for BinaryOpEqI64I64Avx2 {
...
impl BinaryOpCmpF64Avx2Aware for BinaryOpEqF64F64Avx2 {
