...
///
/// - `Dup`s may not refer to indexes that were inserted on before.
///
/// - With the exception of inserting in the middle of a dup, indices may
///   **not** refer to fields that were generated by previous actions.
///
